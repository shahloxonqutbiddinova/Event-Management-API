...
SECRET_KEY = 'django-insecure-7b##r8p%=8l9lr8du7m!9%wwmls!x&by^e&nzu8*^#hfo429k-'
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Final exam project – Event Management System",
    "VERSION": "1.0.0",
}
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=120),  # access token 2 soat
